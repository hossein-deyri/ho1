...
export const FormStyled = styled.form<{ height?: string; width?: string }>(
  ({ height, width }) => `
position: relative;
...
export const UploadStyled = styled.div<{
  ...
  ({ height, width, isFileAvailable }) => `
    border: 1px dashed ${isFileAvailable ? "#1677ff" : "rgba(22, 119, 255, 0.4)"};
    border-opacity: 0.1;
    display: flex; 
...
export const ShowItemNameNewStyle = styled.div<{ width?: string }>(
  ({ width }) => `
